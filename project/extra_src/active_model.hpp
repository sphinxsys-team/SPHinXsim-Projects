/**
 * @file    active_model.hpp
 * @brief   Kernel implementation for the active strain elastic material.
...
{
    // GPU-safe analytical Cholesky for 2x2 symmetric positive-definite A = I + 2*active_strain.
    // Eigen's .llt() relies on static panel-kernel state that is not permitted in device code.
